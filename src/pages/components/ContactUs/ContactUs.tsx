    ...
    <div className="aj-contact-us grid grid-cols-1 lg:grid-cols-2">
      <div className="aj-left-part flex flex-col order-2 lg:order-none">
        ...
        <div className="grid md:grid-cols-2 text-start flex-grow min-h-[207px]">
          <ContactInfo img1={PhoneImage} img2={PhoneImage} text1="+380980099777" text2="+380980099111" title="Phone"/>
          <ContactInfo img2={locationImage} text1="opening hours: 8 to 11 p.m." text2="15/4 Khreshchatyk Street, Kyiv" title="Address"/>
        </div>
      </div>
