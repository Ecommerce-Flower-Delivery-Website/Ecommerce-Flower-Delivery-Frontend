  ...
  return (
    <div className="aj-hero">
      <div className="flex flex-col lg:flex-row">
        {/* Left Column */}
        <div className="w-full lg:w-1/2 border border-[#121212] p-[80px]">
          <h2 className="text-[67px] leading-[80.4px] font-semibold flex flex-col mb-4">Kyiv <span className="flex items-center">LuxeBouquets <sup><Copyright /></sup></span></h2>
          <p className="font-normal text-lg leading-[25.2px] text-[#121212E5]">Discover Uniquely Crafted Bouquets and Gifts for Any Occasion: Spread Joy with Our <span className="italic">Online Flower Delivery Service</span></p>
          <div className="down-part flex pt-6 mt-[54px] items-end border-t border-t-[#121212]">
            <div className="img-container w-full h-[256px] pr-6 mr-6 border-r border-r-[#121212]">
              <img src={HeroImage} alt="girl" className="grayscale w-full h-full object-cover" />
            </div>
