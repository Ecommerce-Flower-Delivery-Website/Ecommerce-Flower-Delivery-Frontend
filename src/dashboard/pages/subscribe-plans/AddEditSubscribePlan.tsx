...
import { addSubscribePlan, updateSubscribePlan } from "../../../store/slices/subscribePlansSlice";
        ...
        {loading ? (
          ...
          <form onSubmit={handleSubmit} className="mt-6  ">
            ...
            <div>
              ...
              <PopoverInfo title="Note" text="You have to add comma ( , ) in the text if have multiple features . For example : fetaure1 , feature 2"/>
              </div>
