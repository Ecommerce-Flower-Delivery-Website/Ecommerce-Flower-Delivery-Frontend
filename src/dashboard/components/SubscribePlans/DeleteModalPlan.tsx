...
const DeleteModalPlan: React.FC<DeleteModalProps> = ({ onClose, onConfirm , id }) => {
  return (
    <div className="fixed inset-0 px-6 z-50 flex justify-center items-center deleteModale bg-background/80 backdrop-blur-sm bg-opacity-50 backdrop-blur-[10px]">
      <div
