...
type CreateUserFormType = z.infer<typeof validateSchemas.createUser>;
 ...
 const RegisterFormDialog = ({isOpen,handleClose}:{isOpen:boolean,handleClose:React.Dispatch<React.SetStateAction<boolean>>}) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose} >
      ...
      <DialogContent aria-describedby={"Sign up"} className="flex flex-col h-full overflow-y-auto sm:rounded-none border-[#121212] shadow-none   max-w-full md:max-w-[722px] px-4 sm:px-20 pt-10 sm:pt-20 pb-10">
        <DialogHeader>
