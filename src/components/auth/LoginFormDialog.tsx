...
const LoginFormDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      ...
      <DialogContent className="light flex flex-col h-full overflow-y-auto  sm:rounded-none border-[#121212] shadow-none   max-w-full md:max-w-[722px] px-4 sm:px-20 pt-10 sm:pt-20 pb-10">
        <DialogHeader>
